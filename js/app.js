 ...
 */
            (function(window, factory) {
                if (true && module.exports) module.exports = factory(window, __webpack_require__(521)); else window.imagesLoaded = factory(window, window.EvEmitter);
 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slaider-main__slider")) new core(".slaider-main__slider", {
                modules: [ Navigation, Pagination, freeMode, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 32,
                ...
                preloadImages: false,
                pagination: {
                    el: ".controls-slaider-main__dotts",
                    clickable: true
                },
                navigation: {
            ...
            if (document.querySelector(".slider-rooms__slider")) new core(".slider-rooms__slider", {
                ...
                navigation: {
                    prevEl: ".slider-rooms .swiper__button_prev",
                    nextEl: ".slider-rooms .swiper__button_next"
                },
                on: {}
            });
            if (document.querySelector(".slider-tips__slider")) new core(".slider-tips__slider", {
                ...
                preloadImages: false,
                pagination: {
                    el: ".slider-tips-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-tips .swiper__button_prev",
                    nextEl: ".slider-tips .swiper__button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
...
***************************************************************************** */
        ...
        window.onload = function() {
            ...
            if (furniture && !isMobile.any()) {
                ...
                function setMouseGalleryStyle() {
                    ...
                    if (Math.abs(distX) > 0) requestAnimationFrame(setMouseGalleryStyle); else furniture.classList.remove("-init");
                }
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            function updateShowmoreContent() {
                const targetElement = document.getElementById("heightShowemore");
                const productsItem = document.querySelector(".products__item.item-product");
                if (targetElement && productsItem) {
                    const newContentHeight = productsItem.clientHeight;
                    targetElement.setAttribute("data-showmore-content", newContentHeight.toString());
                }
            }
            updateShowmoreContent();
            window.addEventListener("resize", updateShowmoreContent);
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
